...
data guidance; set ibes.ibes_guidance;
if periodicity='ANN' & measure='EPS';
run;
...
data actualu; set ibes.actu_epsus;
...
data numest; set ibes.statsum_epsus; 
...
/*** 4. compute restate; ****/
data restate; set 'E:\Data\Audit Analytics\auditnonreli'; run;
...
/**** 5. Internal control weakness ****/
data icw; set audit.auditsox404; 
...
WC = -(RECCH + INVCH + APALCH + TXACH + AOLOCH);
