...
%let begdate = 01Jan1980;*1980 is the very beginning;
...
create table First_Vint
as select distinct *, count(mgrno) as NumInst /*total number of institutions*/
from First_Vint
group by rdate
...
data celim.io; set io_timeseries; run;
